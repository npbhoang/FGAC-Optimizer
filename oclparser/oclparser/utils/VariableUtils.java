...
public class VariableUtils {
     ...
     * @since 1.0
     */
    public static List<Variable> FVars(oclparser.expressions.Expression src) {
        ArrayList<Variable> fVars = new ArrayList<Variable>();

        return FVarsAux(src, fVars);
    }

    private static List<Variable> FVarsAux(oclparser.expressions.Expression src,
            List<Variable> fVars) {
     ...
     * @since 1.0
     */
    public static List<Variable> SVars(oclparser.expressions.Expression ePrime) {
        ...
        for (Variable var : FVars) {
            oclparser.expressions.Expression srcVarExpression = var.getSource();
