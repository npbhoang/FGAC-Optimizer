...
(assert (forall ((s Classifier)) (and (=> (Student s) (exists ((temp Classifier)) (and (Enrollment temp s) (= temp kcaller) (not (or (= s nullClassifier) (= s invalidClassifier))) (not (= kcaller invalidClassifier))))) (not false))))
