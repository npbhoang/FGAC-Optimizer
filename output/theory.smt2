...
(assert (forall ((s Classifier)) (and (=> (Student s) (exists ((temp Classifier)) (and (Enrollment kcaller temp) (= temp s) (not (or (= kcaller nullClassifier) (= kcaller invalidClassifier))) (not (= s invalidClassifier))))) (not false))))
