...
(assert (or (and (= klecturers nullClassifier) (= kcaller nullClassifier)) (and (= klecturers kcaller) (not (or (= klecturers nullClassifier) (= klecturers invalidClassifier) (= kcaller nullClassifier) (= kcaller invalidClassifier))))))
