...
(assert (or (and (= kcaller nullClassifier) (= klecturers nullClassifier)) (and (= kcaller klecturers) (not (or (= kcaller nullClassifier) (= kcaller invalidClassifier) (= klecturers nullClassifier) (= klecturers invalidClassifier))))))
(assert (not (or (or (and (= kcaller nullClassifier) (= klecturers nullClassifier)) (and (= kcaller klecturers) (not (or (= kcaller nullClassifier) (= kcaller invalidClassifier) (= klecturers nullClassifier) (= klecturers invalidClassifier))))) (exists ((temp Classifier)) (and (Enrollment temp kstudents) (= temp kcaller) (not (or (= kstudents nullClassifier) (= kstudents invalidClassifier))) (not (= kcaller invalidClassifier)))))))
(check-sat)
